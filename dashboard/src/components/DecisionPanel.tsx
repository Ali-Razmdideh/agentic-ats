  ...
  return (
    <section className="rounded-xl border border-slate-200 bg-white p-4">
      ...
      <textarea
        ...
        rows={3}
        className="mt-3 block w-full rounded-md border border-slate-300 px-3 py-2 text-sm focus:border-slate-900 focus:outline-none focus:ring-1 focus:ring-slate-900"
      />
